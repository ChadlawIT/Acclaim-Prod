                ...
                <div className="mt-4 space-y-2">
                  ...
                  <label
                    ...
                    className={`flex items-center justify-center gap-2 border-2 border-dashed rounded-xl cursor-pointer transition-all text-center ${
                      messageAttachments.length > 0 ? "px-3 py-2" : "flex-col px-4 py-5"
                  ...
                  >
                    ...
                    <span className={`text-sm transition-colors ${isDragOverAttachment ? "text-teal-700 dark:text-teal-300" : "text-gray-500"}`}>
                      {isDragOverAttachment ? "Drop files here" : messageAttachments.length > 0 ? "Drop or click to add more files" : "Click to browse or drag files here"}
                    </span>
                    {messageAttachments.length === 0 && <span className="text-xs text-gray-400 w-full">{ACCEPTED_FILE_TYPES_DISPLAY} · {MAX_FILE_SIZE_MB}MB each</span>}
                  </label>
            ...
            <div className="pt-4 border-t space-y-3">
              ...
              <div className="space-y-1.5">
                ...
                <label
                  ...
                  className={`flex items-center justify-center gap-2 border-2 border-dashed rounded-xl cursor-pointer transition-all text-center ${
                    dialogReplyFiles.length > 0 ? "px-3 py-2" : "flex-col px-4 py-5"
                ...
                >
                  ...
                  <span className={`text-sm ${dialogReplyIsDragOver ? "text-teal-700 dark:text-teal-300" : "text-gray-500"}`}>
                    {dialogReplyIsDragOver ? "Drop files here" : dialogReplyFiles.length > 0 ? "Drop or click to add more files" : "Click to browse or drag files here"}
                  </span>
                  {dialogReplyFiles.length === 0 && <span className="text-xs text-gray-400 w-full">{ACCEPTED_FILE_TYPES_DISPLAY} · {MAX_FILE_SIZE_MB}MB each</span>}
                </label>
