...
- **Session Storage**: PostgreSQL-backed sessions with an 8-hour rolling inactivity timeout (the timer resets on each request), secured with HTTP-only cookies and CSRF protection.
