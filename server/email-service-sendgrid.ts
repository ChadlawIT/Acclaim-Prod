                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width: 600px; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
                  ...
                  <tr>
                    <td style="background-color: #ffffff; padding: 28px 40px 24px 40px; text-align: center; border-bottom: 4px solid #0d9488;">
                      <img src="cid:logo" alt="Acclaim" width="240" height="82" style="width: 240px; height: 82px; display: block; margin: 0 auto 20px auto;" />
                  ...
                  <tr>
                    <td style="padding: 40px;">
                      ...
                      <div style="text-align: center;">
                        ...
                        <p style="color: #94a3b8; font-size: 12px; margin-top: 16px; margin-bottom: 0;">You can reply directly to this email, or log in to the portal above to view the full case history and respond there.</p>
                      </div>
                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width: 600px; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
                  ...
                  <tr>
                    <td style="background-color: #7c3aed; background: linear-gradient(135deg, #7c3aed 0%, #5b21b6 100%); padding: 40px 40px 32px 40px; text-align: center;">
                      ...
                      <h1 style="margin: 0; color: #1a2e44; font-size: 22px; font-weight: 600; letter-spacing: -0.5px;">Super Admin Access Granted</h1>
                      <p style="margin: 8px 0 0 0; color: #475569; font-size: 14px;">Acclaim Client Portal</p>
                    </td>
                  </tr>
...
You can reply directly to this email, or log in to the Acclaim Portal to view this message and respond there.
Portal: https://acclaim-api-prod-uks-001.azurewebsites.net/auth
      `;
                  ...
                  <tr>
                    <td style="padding: 40px;">
                      ...
                      <div style="text-align: center;">
                        ...
                        <p style="color: #94a3b8; font-size: 12px; margin-top: 16px; margin-bottom: 0;">You can reply directly to this email, or log in to the portal above to view and download the document.</p>
                      </div>
...
You can reply directly to this email, or log in to the Acclaim Portal to view and download this document.
Portal: https://acclaim-api-prod-uks-001.azurewebsites.net/auth
      `;
